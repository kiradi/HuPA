...
def Fetch_Approved_PMID():
	...
	#PubMed Indexed
	q="select * from PubMed_Index, Entry_Log, PubMed_Anno where PubMed_Index.status='Approved' and PubMed_Index.pubmed=Entry_Log.pubmed and PubMed_Index.pubmed=PubMed_Anno.pubmed and PubMed_Anno.pubmed=Entry_Log.pubmed and Entry_Log.status='Approved' and PubMed_Anno.status='Approved'"
	cursor.execute(q)
